...
def set_parameters_from_optimized(n):
    ...
    n.links.loc[links_dc_i, 'p_nom_max'] = gen_capacities.loc[gen_extend_i,:].max(axis=1)
    n.links.loc[links_dc_i, 'p_nom_min'] = gen_capacities.loc[gen_extend_i,:].mean(axis=1)
...
if __name__ == "__main__":
    if 'snakemake' not in globals():
        ...
        snakemake = mock_snakemake('build_robust_capacities', network='elec',
                                  simpl='', clusters='10', ll='v1.0', opts='Co2L0p0-3H')
    ...
    n = set_parameters_from_optimized(n)
    #del n_optim
