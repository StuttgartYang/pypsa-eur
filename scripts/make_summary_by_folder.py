...
def make_summaries(networks_dict):
    ...
    for label, filename in iteritems(networks_dict):
        ...
        costs = load_costs(Nyears, tech_costs="data/costs.csv", config=snakemake.config['costs'], elec_config = snakemake.config['electricity'])
            # load_costs(Nyears, snakemake.input[0],
